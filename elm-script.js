...
var $author$project$Main$init = {E: ''};
...
var $author$project$Main$UpdatePercent = $elm$core$Basics$identity;
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$name('percent'),
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$name('percent'),
										$elm$html$Html$Events$onClick('20')
									]),
								_List_Nil)
							])),
						A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										$elm$html$Html$Attributes$name('percent'),
										$elm$html$Html$Events$onClick('30')
									]),
								_List_Nil)
							]))
					])),
